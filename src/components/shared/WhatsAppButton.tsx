...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-xs md:text-sm font-bold tracking-widest uppercase pl-6 pr-2 text-white">
          WhatsApp
        </span>
      </motion.div>

      <div className="relative z-10 flex items-center justify-center w-14 md:w-16 h-full flex-shrink-0">
        <svg
          fill="currentColor"
          viewBox="0 0 32 32"
          className="w-7 h-7 md:w-8 md:h-8 text-[#25D366] drop-shadow-[0_0_8px_rgba(37,211,102,0.5)]"
        >
      ...
      {/* Corner Accents */}
      <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-[#25D366] opacity-0 group-hover:opacity-100 transition-opacity" />
      <div className="absolute bottom-0 right-0 w-2 h-2 border-b border-r border-[#25D366] opacity-0 group-hover:opacity-100 transition-opacity" />
    </motion.button>
  );
}
